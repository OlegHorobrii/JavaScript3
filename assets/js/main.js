...
let list = [12, 23, 100, 34, 56, 9, 233, 12346, 13264.46];
let myMax = function (arr) {
  return Math.max.apply(Math, arr);
};
console.log(myMax(list)); // 13264.46
...
let notUniqNums = [1, 1, 1, 2, 3, 4, 5, 6, 7, 17, 28];

let notUniqStrings = ['Oleg', 'Bob', 'Kate', 'Jhon', 'Tom', 'Jhon', 'Kate', 'Tom', 'Bob', 'Jhon', 'Tom'];
